...
const DetailPengajuan = () => {
  return (
    <div className="py-[30px] px-5 ">
      ...
      <div className="mt-5">
      <p className="text-lg font-normal mb-[10px]">Catatan Review</p>
        <form action="">
          <textarea className="w-full h-20 rounded-2xl border border-[#E5E7EB] p-3" placeholder="Masukan Review" name="" id=""></textarea>
        </form>
      </div>
    </div>
  );
